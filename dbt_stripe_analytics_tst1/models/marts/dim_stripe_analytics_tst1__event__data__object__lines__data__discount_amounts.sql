...
SELECT
    ...
    t."_dlt_list_idx",
    t."_dlt_id",
FROM  {{ ref('stg_stripe_analytics_tst1__event__data__object__lines__data__discount_amounts') }} as t
/* this join to the parent table is not necesarily needed for this template to work */
JOIN {{ ref('stg_stripe_analytics_tst1__event__data__object__lines__data') }} as pt
