...
-- depends_on: {{ ref('stg_stripe_analytics_tst1__balance_transaction') }}
...
WHERE "_dlt_parent_id" IN ( SELECT "_dlt_id" FROM {{ ref('stg_stripe_analytics_tst1__balance_transaction') }} )
